...
Source data update frequency: As needed

Last updated here: June 29th, 2021, added to Tribal Water Data Map in May 2025
...
Source data update frequency: Every 10 years

Last updated here: 2024
...
Source data update frequency: Every 2 years
...
*screenshot here, layer not present*
...
Source data update frequency: Monthly

Last updated here: May 25th, 2025
...
Source data update frequency: Daily

Last updated here: downloaded 2025/05/21
...
Source data update frequency: Nightly
...
Source data update frequency: Weekly, on Thursdays
...
![Screenshot of interactive map showing watershed boundaries](images/layer-guide_watershed-boundaries-calfire.png)
...
Last updated here: September 7th, 2023
...
Last updated here: December 11, 2024
...
[State Marine Reserve (SMP):]{.ul} An MPA where no take, damage, injury, or possession of any living, geologic, or cultural marine resource is allowed.

[No-Take State Marine Conservation Area (NoTake SMCA):]{.ul} An MPA where no take of any living, geologic, or cultural resource is allowed, EXCEPT for take incidental to specified activities permitted by other agencies (e.g. infrastructure maintenance, sand renourishment).

[State Marine Park (SMP)]{.ul}: An MPA that allows some recreational take but does not allow commerical take.

[State Marine Conservation Area (SMCA)]{.ul}: An MPA where some recreational and/or commercial take of marine resources may be allowed (restrictions vary)

[State Marine Recreational Management Area (SMRMA)]{.ul}: A marine managed area where some take of marine resources may be allowed and legal waterfowl hunting is allowed (restrictions vary)

[Special Closure]{.ul}: Prohibits or restricts access in waters adjacent to seabird rookeries or marine mammal haul-out sites.
