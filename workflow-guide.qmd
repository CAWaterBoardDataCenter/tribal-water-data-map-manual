...
2.  Make sure you're logged into the OIMA credentials. Then, from "Portal," find "California_State_Boundary_shp." (This is a shapefile of California's border) and add it as a layer to the current map. 
