...
7.  Use the eye button to make only the new layer visible, and screenshot the map. This photo will be used in the user manual.

![](workflow-guide-images/layer-editing.png){fig-align="center" width="329"}
...
3.  ***TO BE UPDATED: Thumbnail***

### Sharing Layers Publicly

Feature layers are not publicly shared until the GIS team pushes.

1.  ***TO BE UPDATED: Public publishing request form via GIS Wiki?***

2.  Only applicable if your feature layer is not already publicly shared data (i.e. you have sourced and created this data layer yourself which is probably not the case): the Information Security Officer (ISO) requires that you submit a Data Categorization Package (Data Cat). [Check the Data Cat instructions document here](https://cawaterboards.sharepoint.com/sites/RiskManagement/DataCategorizationLibrary/Forms/AllItems.aspx).
